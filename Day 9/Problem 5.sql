-- Find the months in which we had more than 2 orders.

-- Creating Orders table
CREATE TABLE Orders
(OrderID INT,CustomerID INT,Product VARCHAR(20)
,Category VARCHAR(20),Amount INT,OrderDate DATE)

-- Inserting values inot Orders table
